...
import { AssetDataDetailed, IAssetApplication } from "@/types/Property";
...
const PropertyDetail = () => {
  ...
  const handleApply = async () => {
    ...
    if(profileCode){
        if(asset){
        const payload: IAssetApplication = {
                          ...
                          <div>
                              ...
                              <div className="hidden lg:block">
                                  <SectionWrapper title="Quick Actions" Icon={Zap}>
                                      <Button onClick={handleApply} variant='neutral' disable={false} isSubmitBtn={false}>
                                        <Send size={16} /> Apply
                                      </Button>
                                  </SectionWrapper>
                              </div>
