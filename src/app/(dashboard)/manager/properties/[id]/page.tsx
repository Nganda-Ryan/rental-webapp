...
import TenantInfoDisplay from "@/components/Layouts/TenantInfoDisplay";
                                ...
                                { asset ?
                                    <div className="lg:col-span-2 space-y-4 h-fit">
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
                                            ...
                                            {tenantInfo && <div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4 border-t border-gray-100 dark:border-gray-700">
                                                <div>
