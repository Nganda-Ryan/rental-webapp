...
export const VARIANTS = {
    info: `
      ...
      dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700 dark:focus:ring-blue-900
    `,
    danger: `
      bg-red-500 text-white hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-red-100
      dark:bg-red-600 dark:text-white dark:hover:bg-red-700 dark:focus:ring-red-900
    `,
    warning: `
      bg-yellow-400 text-black hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-100
      dark:bg-yellow-500 dark:text-black dark:hover:bg-yellow-600 dark:focus:ring-yellow-900
    `,
    success: `
      bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-100
      dark:bg-green-600 dark:text-white dark:hover:bg-green-700 dark:focus:ring-green-900
    `,
    neutral: `
      text-white bg-[#2A4365] hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-200 
      dark:bg-[#2A4365] dark:text-white dark:hover:bg-[#1A365D] dark:focus:ring-blue-800 transition-colors duration-150
    `,
    'outline-info': `
    ...
    `,
    'outline-danger': `border border-red-500 text-red-500 hover:bg-red-50 focus:outline-none focus:ring-4 focus:ring-red-100 dark:border-red-400 dark:text-red-400 dark:hover:bg-red-900/20 dark:focus:ring-red-800 transition-colors duration-150`,
