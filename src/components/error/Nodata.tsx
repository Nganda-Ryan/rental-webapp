...
const Nodata = ({message}: {message?: string}) => {
  ...
  return (
    <div className="w-full h-[50vh] flex flex-col shrink-1 items-center justify-center py-12 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 rounded-lg shadow-sm pt-3">
        <svg
